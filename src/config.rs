...
pub struct ItemConfig {
    ...
    pub effect_melee_hp_percent_damage: Option<f64>,
    pub effect_ranged_hp_percent_damage: Option<f64>,
    ...
    pub effect_melee_damaged_amplify: Option<usize>,
    pub effect_ranged_damaged_amplify: Option<usize>,
