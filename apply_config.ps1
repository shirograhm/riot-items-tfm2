...
$zekAura = "Aura: Grant <#d48294ff>{0}<> <$forceIcon> <#d48294ff>Adaptive Force<> and <#b7462dff>{2}%<> <$vampIcon> <#b7462dff>Omnivamp<> to all allied champions within <#ff86c2ff>{1} <$rangeIcon> range<>, including yourself."
...
$zekAuraVi = "Hào Quang: Cấp <#d48294ff>{0}<> <$forceIcon> <#d48294ff>Lực Thích Ứng<> và <#b7462dff>{2}%<> <$vampIcon> <#b7462dff>hút máu<> cho mọi tướng đồng minh trong phạm vi <#ff86c2ff>{1}<> <$rangeIcon>, bao gồm cả bản thân."
...
$zekAuraZh = "光环：为 <#ff86c2ff>{1} <$rangeIcon> 射程<>范围内的所有友方英雄提供 <#d48294ff>{0}<> <$forceIcon> <#d48294ff>自适应之力<> 和 <#b7462dff>{2}%<> <$vampIcon> <#b7462dff>全能吸血<>，包括你自己。"
...
$zekAuraPt = "Aura: Concede <#d48294ff>{0}<> <$forceIcon> de <#d48294ff>Força Adaptativa<> e <#b7462dff>{2}%<> <$vampIcon> <#b7462dff>roubo de vida<> a todos os campeões aliados dentro de <#ff86c2ff>{1} <$rangeIcon> alcance<>, incluindo você mesmo."
...
$zekAuraRu = "Аура: Даёт <#d48294ff>{0}<> <$forceIcon> <#d48294ff>адаптивной силы<> и <#b7462dff>{2}%<> <$vampIcon> <#b7462dff>всестороннего вытягивания жизни<> всем союзным чемпионам в пределах <#ff86c2ff>{1} <$rangeIcon> дальности<>, включая вас самих."
