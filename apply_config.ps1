...
$i18n.vi.warmogs_armor.option = "Tim Warmog: Hồi <#60e84dff>${waHeal}%<> <i#asset/base/ui/banpick/champion_stat_icon:hp_0> <#60e84dff>máu tối đa<> mỗi giây và nhận <#ffffffff>${waMs}%<> <i#asset/base/ui/banpick/champion_stat_icon:speed_0> <#ffffffff>tốc độ di chuyển<> nếu bạn không nhận sát thương trong <#e8a800ff>${waDur} giây<>."
$i18n.vi.radiant_warmogs_armor.option = "Tim Warmog Ánh Sáng: Hồi <#60e84dff>${rwaHeal}%<> <i#asset/base/ui/banpick/champion_stat_icon:hp_0> <#60e84dff>máu tối đa<> mỗi giây và nhận <#ffffffff>${rwaMs}%<> <i#asset/base/ui/banpick/champion_stat_icon:speed_0> <#ffffffff>tốc độ di chuyển<> nếu bạn không nhận sát thương trong <#e8a800ff>${rwaDur} giây<>."
