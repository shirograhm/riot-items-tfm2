...
$ntApPct = if ($null -ne $config.nashors_tooth.effect_ap_percent_damage) { [int]$config.nashors_tooth.effect_ap_percent_damage }              else { 3 }
...
$rntApPct = if ($null -ne $config.radiant_nashors_tooth.effect_ap_percent_damage) { [int]$config.radiant_nashors_tooth.effect_ap_percent_damage } else { 5 }
$rmHpPct = if ($null -ne $config.riftmaker.effect_caster_hp_percent_power) { [int]$config.riftmaker.effect_caster_hp_percent_power }              else { 2 }
...
$rrmHpPct = if ($null -ne $config.radiant_riftmaker.effect_caster_hp_percent_power) { [int]$config.radiant_riftmaker.effect_caster_hp_percent_power } else { 2 }
...
$fmSlow = if ($null -ne $config.frozen_mallet.effect_slow_percent) { [int]$config.frozen_mallet.effect_slow_percent }                              else { 25 }
$fmDur = if ($null -ne $config.frozen_mallet.effect_duration_seconds) { [int]$config.frozen_mallet.effect_duration_seconds }                          else { 2 }
$rfmSlow = if ($null -ne $config.radiant_frozen_mallet.effect_slow_percent) { [int]$config.radiant_frozen_mallet.effect_slow_percent }                else { 25 }
...
$rfmHpPct = if ($null -ne $config.radiant_frozen_mallet.effect_caster_hp_percent_damage) { [int]$config.radiant_frozen_mallet.effect_caster_hp_percent_damage } else { 3 }
...
$svHeal = if ($null -ne $config.spirit_visage.effect_heal_mult) { [int]$config.spirit_visage.effect_heal_mult }                             else { 20 }
$rsvHeal = if ($null -ne $config.radiant_spirit_visage.effect_heal_mult) { [int]$config.radiant_spirit_visage.effect_heal_mult }               else { 20 }
...
$udHpPct = if ($null -ne $config.unending_despair.effect_caster_hp_percent_heal) { [int]$config.unending_despair.effect_caster_hp_percent_heal } else { 1 }
...
$rudHpPct = if ($null -ne $config.radiant_unending_despair.effect_caster_hp_percent_heal) { [int]$config.radiant_unending_despair.effect_caster_hp_percent_heal } else { 3 }
...
$phHpPct = if ($null -ne $config.protoplasm_harness.effect_hp_percent_boost) { [int]$config.protoplasm_harness.effect_hp_percent_boost }                  else { 25 }
...
$rphHpPct = if ($null -ne $config.radiant_protoplasm_harness.effect_hp_percent_boost) { [int]$config.radiant_protoplasm_harness.effect_hp_percent_boost }  else { 25 }
