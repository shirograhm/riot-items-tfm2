...
$rhTemplate = "Cleave: Basic attacks deal <#ff9028ff>{0}%<> of your <$adIcon> <#ff9028ff>Attack Damage<> as <#ff9028ff>physical damage<> to nearby enemies. Attacks from further than <#ff86c2ff>{1} <$rangeIcon> range<> apply this effect at <#d94c49ff>{2}% strength<>."
...
$rhTemplateVi = "Sát Thương Lan: Đòn đánh thường gây <#ff9028ff>{0}%<> <$adIcon> <#ff9028ff>SMCK<> dưới dạng <#ff9028ff>sát thương vật lí<> lên kẻ địch xung quanh. Đòn đánh từ xa hơn <#ff86c2ff>{1}<> <$rangeIcon> chỉ áp dụng hiệu ứng này ở <#d94c49ff>{2}% sức mạnh<>."
...
$rhTemplateZh = "顺劈：普通攻击会对附近的敌人造成相当于你 <$adIcon> <#ff9028ff>攻击力<>的 <#ff9028ff>{0}%<> 的<#ff9028ff>物理伤害<>。从超过 <#ff86c2ff>{1} <$rangeIcon> 射程<>外发动的攻击，此效果仅以 <#d94c49ff>{2}% 强度<>触发。"
...
$rhTemplatePt = "Fenda: Ataques básicos causam <#ff9028ff>{0}%<> do seu <$adIcon> <#ff9028ff>Dano de Ataque<> como <#ff9028ff>dano físico<> a inimigos próximos. Ataques de mais de <#ff86c2ff>{1} <$rangeIcon> alcance<> aplicam este efeito com <#d94c49ff>{2}% de intensidade<>."
...
$rhTemplateRu = "Рассечение: Базовые атаки наносят <#ff9028ff>{0}%<> вашей <$adIcon> <#ff9028ff>силы атаки<> в виде <#ff9028ff>физического урона<> ближайшим врагам. Атаки с расстояния больше <#ff86c2ff>{1} <$rangeIcon> дальности<> применяют этот эффект с <#d94c49ff>{2}% силы<>."
...
$rhTemplateKo = "쪼개기: 기본 공격 시 주변 적들에게 <$adIcon> <#ff9028ff>공격력의 {0}%<>만큼 <#ff9028ff>물리 피해<>를 입힙니다. <$rangeIcon> <#ff86c2ff>사거리 {1}<>보다 먼 곳에서의 공격은 이 효과가 <#d94c49ff>{2}% 위력<>으로 적용됩니다."
