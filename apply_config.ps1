...
$i18n.en.rylais_crystal_scepter.option = "Rimefrost: Dealing Ability damage slows units hit by <#d94c49ff>${rcsSlow}%<> for <#e8a800ff>${rcsDur} seconds<>."
$i18n.en.radiant_rylais_crystal_scepter.option = "Rimefrost: Dealing Ability damage slows units hit by <#d94c49ff>${rrcsSlow}%<> for <#e8a800ff>${rrcsDur} seconds<>."
