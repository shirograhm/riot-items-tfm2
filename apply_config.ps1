...
$zekForce = [int]$config.zekes_herald.adaptive_force
$rzekForce = [int]$config.radiant_zekes_herald.adaptive_force
...
$zekAura = "Aura: Grant <#d48294ff>{0}<> <$forceIcon> <#d48294ff>Adaptive Force<> to all allied champions within <#e8a800ff>{1} units<>."
...
$dtsPierceVi = "Xuyên Thấu: Nhận <#d48294ff>{0}<> <$forceIcon> <#d48294ff>Lực Thích Ứng<>. Với mỗi <$forceIcon> <#d48294ff>Lực Thích Ứng<> tăng <#ff9028ff>0.6<> <$adIcon> <#ff9028ff>SMCK<> hoặc <#a974ffff>1<> <$apIcon> <#a974ffff>SMPT<>, tùy vào bên nào cao hơn.`n`nĐiểm Lý Tưởng: Gây tối đa <#e8a800ff>{1}% sát thương cộng thêm<> lên tướng địch dựa trên khoảng cách (khoảng cách tối đa <#e8a800ff>{2} đơn vị<>)."
...
$zekAuraVi = "Hào Quang: Cấp <#d48294ff>{0}<> <$forceIcon> <#d48294ff>Lực Thích Ứng<> cho mọi tướng đồng minh trong phạm vi <#e8a800ff>{1} đơn vị<>."
...
$dtsPierceZh = "穿刺：获得 <#d48294ff>{0}<> <$forceIcon> <#d48294ff>自适应之力<>。每点 <$forceIcon> <#d48294ff>自适应之力<>会根据较高者提供 <#ff9028ff>0.6<> <$adIcon> <#ff9028ff>攻击力<>或 <#a974ffff>1<> <$apIcon> <#a974ffff>法术强度<>。`n`n最佳距离：根据距离对敌方英雄造成最多 <#e8a800ff>{1}% 额外伤害<>（最大距离 <#e8a800ff>{2} 单位<>）。"
...
$zekAuraZh = "光环：为 <#e8a800ff>{1} 单位<>范围内的所有友方英雄提供 <#d48294ff>{0}<> <$forceIcon> <#d48294ff>自适应之力<>。"
...
$zekAuraPt = "Aura: Concede <#d48294ff>{0}<> <$forceIcon> de <#d48294ff>Força Adaptativa<> a todos os campeões aliados dentro de <#e8a800ff>{1} unidades<>."
...
$zekAuraRu = "Аура: Даёт <#d48294ff>{0}<> <$forceIcon> <#d48294ff>адаптивной силы<> всем союзным чемпионам в пределах <#e8a800ff>{1} единиц<>."
