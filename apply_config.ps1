...
$i18n.en.shadowflame.option = "Cinderbloom: Your <#a974ffff>magic damage<> is <#ff9028ff>20% stronger<> against enemies <#d94c49ff>below ${sfThreshold}% maximum health<>."
$i18n.en.radiant_shadowflame.option = "Cinderbloom: Your <#a974ffff>magic damage<> is <#ff9028ff>20% stronger<> against enemies <#d94c49ff>below ${rsfThreshold}% maximum health<>."
$i18n.en.yun_tal_wildarrows.option = "Practice Makes Lethal: Dealing <#ff9028ff>physical damage<> grants <#d45656ff>${ytCrit}%<> <$critIcon> <#d45656ff>critical strike chance<> permanently, up to <#d45656ff>${ytMaxCrit}%<> <$critIcon>.`n`nFlurry: On attack, gain <#ceff99ff>${ytFlurryAS}%<> <$asIcon> <#ceff99ff>attack speed<> for <#e8a800ff>${ytDur} seconds<> (${ytCd} second cooldown)."
$i18n.en.radiant_yun_tal_wildarrows.option = "Practice Makes Lethal: Dealing <#ff9028ff>physical damage<> grants <#d45656ff>${rytCrit}%<> <$critIcon> <#d45656ff>critical strike chance<> permanently, up to <#d45656ff>${rytMaxCrit}%<> <$critIcon>.`n`nFlurry: On attack, gain <#ceff99ff>${rytFlurryAS}%<> <$asIcon> <#ceff99ff>attack speed<> for <#e8a800ff>${rytDur} seconds<> (${rytCd} second cooldown)."
...
$i18n.en.deaths_dance.option = "Ignore Pain: <#e8a800ff>${ddDelay}%<> of the damage you take is dealt over time as <#ff9028ff>physical damage<> (up to <#60e84dff>${ddBurnCap}%<> of your <$hpIcon> <#60e84dff>maximum health<> per second).`n`nDefy: On kill, cleanse leftover stored damage and <#60e84dff>heal<> for <#60e84dff>${ddHeal}%<> of your <#60e84dff>missing health<>."
$i18n.en.radiant_deaths_dance.option = "Ignore Pain: <#e8a800ff>${rddDelay}%<> of the damage you take is dealt over time as <#ff9028ff>physical damage<> (up to <#60e84dff>${rddBurnCap}%<> of your <$hpIcon> <#60e84dff>maximum health<> per second).`n`nDefy: On kill, cleanse leftover stored damage and <#60e84dff>heal<> for <#60e84dff>${rddHeal}%<> of your <#60e84dff>missing health<>."
...
$i18n.en.turbo_chemtank.option = "Supercharged: Gain <#d48294ff>${tcForce}<> <$forceIcon> <#d48294ff>Adaptive Force<>. Taking damage from an enemy champion grants <#ffffffff>${tcMs}%<> <$speedIcon> <#ffffffff>movement speed<> and <#92dc7bff>crowd control immunity<> for <#e8a800ff>${tcDur} seconds<> (${tcCd} second cooldown)."
$i18n.en.radiant_turbo_chemtank.option = "Supercharged: Gain <#d48294ff>${rtcForce}<> <$forceIcon> <#d48294ff>Adaptive Force<>. Taking damage from an enemy champion grants <#ffffffff>${rtcMs}%<> <$speedIcon> <#ffffffff>movement speed<> and <#92dc7bff>crowd control immunity<> for <#e8a800ff>${rtcDur} seconds<> (${rtcCd} second cooldown)."
$i18n.en.stormrazor.option = "Energized: Gain <#e8a800ff>1<> stack of Energize every second and <#e8a800ff>3<> stacks whenever you deal <#ff9028ff>physical damage<>, up to <#e8a800ff>${srStacks}<>.`n`nBolt: At <#e8a800ff>${srStacks}<> Energize stacks, your next instance of <#ff9028ff>physical damage<> consumes all stacks to deal <#a974ffff>${srDmg} bonus magic damage<> and grants you <#ffffffff>${srMs}%<> <$speedIcon> <#ffffffff>bonus movement speed<> for <#e8a800ff>${srDur} seconds<>."
$i18n.en.radiant_stormrazor.option = "Energized: Gain <#e8a800ff>1<> stack of Energize every second and <#e8a800ff>3<> stacks whenever you deal <#ff9028ff>physical damage<>, up to <#e8a800ff>${rsrStacks}<>.`n`nBolt: At <#e8a800ff>${rsrStacks}<> Energize stacks, your next instance of <#ff9028ff>physical damage<> consumes all stacks to deal <#a974ffff>${rsrDmg} bonus magic damage<> and grants you <#ffffffff>${rsrMs}%<> <$speedIcon> <#ffffffff>bonus movement speed<> for <#e8a800ff>${rsrDur} seconds<>."
...
$i18n.vi.shadowflame.option = "Hạt Tro: <#a974ffff>Sát thương phép<> của bạn <#ff9028ff>mạnh hơn 20%<> khi gây lên kẻ địch <#d94c49ff>dưới ${sfThreshold}% máu tối đa<>."
$i18n.vi.radiant_shadowflame.option = "Hạt Tro: <#a974ffff>Sát thương phép<> của bạn <#ff9028ff>mạnh hơn 20%<> khi gây lên kẻ địch <#d94c49ff>dưới ${rsfThreshold}% máu tối đa<>."
...
$i18n.vi.turbo_chemtank.option = "Tăng Áp: Nhận <#d48294ff>${tcForce}<> <$forceIcon> <#d48294ff>Lực Thích Ứng<>. Khi nhận sát thương từ tướng địch, nhận <#ffffffff>${tcMs}%<> <$speedIcon> <#ffffffff>tốc độ di chuyển<> và <#92dc7bff>miễn nhiễm hiệu ứng khống chế<> trong <#e8a800ff>${tcDur} giây<> (hồi chiêu ${tcCd} giây)."
$i18n.vi.radiant_turbo_chemtank.option = "Tăng Áp: Nhận <#d48294ff>${rtcForce}<> <$forceIcon> <#d48294ff>Lực Thích Ứng<>. Khi nhận sát thương từ tướng địch, nhận <#ffffffff>${rtcMs}%<> <$speedIcon> <#ffffffff>tốc độ di chuyển<> và <#92dc7bff>miễn nhiễm hiệu ứng khống chế<> trong <#e8a800ff>${rtcDur} giây<> (hồi chiêu ${rtcCd} giây)."
$i18n.vi.stormrazor.option = "Tích Điện: Nhận <#e8a800ff>1<> điểm Tích Điện mỗi giây và <#e8a800ff>3<> điểm mỗi khi gây <#ff9028ff>sát thương vật lí<>, tối đa <#e8a800ff>${srStacks}<>.`n`nTia Sét: Khi đạt <#e8a800ff>${srStacks}<> điểm Tích Điện, đòn <#ff9028ff>sát thương vật lí<> tiếp theo tiêu hao toàn bộ điểm để gây <#a974ffff>${srDmg} sát thương phép cộng thêm<> và tăng <#ffffffff>${srMs}%<> <$speedIcon> <#ffffffff>tốc độ di chuyển<> trong <#e8a800ff>${srDur} giây<>."
$i18n.vi.radiant_stormrazor.option = "Tích Điện: Nhận <#e8a800ff>1<> điểm Tích Điện mỗi giây và <#e8a800ff>3<> điểm mỗi khi gây <#ff9028ff>sát thương vật lí<>, tối đa <#e8a800ff>${rsrStacks}<>.`n`nTia Sét: Khi đạt <#e8a800ff>${rsrStacks}<> điểm Tích Điện, đòn <#ff9028ff>sát thương vật lí<> tiếp theo tiêu hao toàn bộ điểm để gây <#a974ffff>${rsrDmg} sát thương phép cộng thêm<> và tăng <#ffffffff>${rsrMs}%<> <$speedIcon> <#ffffffff>tốc độ di chuyển<> trong <#e8a800ff>${rsrDur} giây<>."
...
$i18n.'zh-hans'.shadowflame.option = "余烬绽放：你的<#a974ffff>魔法伤害<>对<#d94c49ff>最大生命值低于${sfThreshold}%<>的敌人<#ff9028ff>提高20%<>。"
$i18n.'zh-hans'.radiant_shadowflame.option = "余烬绽放：你的<#a974ffff>魔法伤害<>对<#d94c49ff>最大生命值低于${rsfThreshold}%<>的敌人<#ff9028ff>提高20%<>。"
...
$i18n.'zh-hans'.turbo_chemtank.option = "增压：获得 <#d48294ff>${tcForce}<> <$forceIcon> <#d48294ff>自适应之力<>。受到敌方英雄伤害时，获得 <#ffffffff>${tcMs}%<> <$speedIcon> <#ffffffff>移动速度<>和 <#92dc7bff>控制免疫<>，持续 <#e8a800ff>${tcDur}秒<>（冷却${tcCd}秒）。"
$i18n.'zh-hans'.radiant_turbo_chemtank.option = "增压：获得 <#d48294ff>${rtcForce}<> <$forceIcon> <#d48294ff>自适应之力<>。受到敌方英雄伤害时，获得 <#ffffffff>${rtcMs}%<> <$speedIcon> <#ffffffff>移动速度<>和 <#92dc7bff>控制免疫<>，持续 <#e8a800ff>${rtcDur}秒<>（冷却${rtcCd}秒）。"
$i18n.'zh-hans'.stormrazor.option = "蓄能：每秒获得 <#e8a800ff>1<> 层蓄能，每次造成 <#ff9028ff>物理伤害<> 时获得 <#e8a800ff>3<> 层，最多 <#e8a800ff>${srStacks}<> 层。`n`n雷霆：拥有 <#e8a800ff>${srStacks}<> 层蓄能时，你的下一次 <#ff9028ff>物理伤害<> 会消耗所有蓄能，额外造成 <#a974ffff>${srDmg} 点魔法伤害<>，并使你获得 <#ffffffff>${srMs}%<> <$speedIcon> <#ffffffff>移动速度<>，持续 <#e8a800ff>${srDur}秒<>。"
$i18n.'zh-hans'.radiant_stormrazor.option = "蓄能：每秒获得 <#e8a800ff>1<> 层蓄能，每次造成 <#ff9028ff>物理伤害<> 时获得 <#e8a800ff>3<> 层，最多 <#e8a800ff>${rsrStacks}<> 层。`n`n雷霆：拥有 <#e8a800ff>${rsrStacks}<> 层蓄能时，你的下一次 <#ff9028ff>物理伤害<> 会消耗所有蓄能，额外造成 <#a974ffff>${rsrDmg} 点魔法伤害<>，并使你获得 <#ffffffff>${rsrMs}%<> <$speedIcon> <#ffffffff>移动速度<>，持续 <#e8a800ff>${rsrDur}秒<>。"
...
$i18n.'pt-BR'.shadowflame.option = "Floregris: Seu <#a974ffff>dano mágico<> é <#ff9028ff>20% mais forte<> contra inimigos <#d94c49ff>abaixo de ${sfThreshold}% da Vida Máxima<>."
$i18n.'pt-BR'.radiant_shadowflame.option = "Floregris: Seu <#a974ffff>dano mágico<> é <#ff9028ff>20% mais forte<> contra inimigos <#d94c49ff>abaixo de ${rsfThreshold}% da Vida Máxima<>."
...
$i18n.'pt-BR'.turbo_chemtank.option = "Supercarregado: Ganha <#d48294ff>${tcForce}<> <$forceIcon> de <#d48294ff>Força Adaptativa<>. Receber dano de um campeão inimigo concede <#ffffffff>${tcMs}%<> de <$speedIcon> <#ffffffff>Velocidade de Movimento<> e <#92dc7bff>imunidade a controle de grupo<> por <#e8a800ff>${tcDur} segundos<> (recarga de ${tcCd} segundos)."
$i18n.'pt-BR'.radiant_turbo_chemtank.option = "Supercarregado: Ganha <#d48294ff>${rtcForce}<> <$forceIcon> de <#d48294ff>Força Adaptativa<>. Receber dano de um campeão inimigo concede <#ffffffff>${rtcMs}%<> de <$speedIcon> <#ffffffff>Velocidade de Movimento<> e <#92dc7bff>imunidade a controle de grupo<> por <#e8a800ff>${rtcDur} segundos<> (recarga de ${rtcCd} segundos)."
$i18n.'pt-BR'.stormrazor.option = "Energizado: Ganha <#e8a800ff>1<> acúmulo de Energia por segundo e <#e8a800ff>3<> acúmulos sempre que causa <#ff9028ff>dano físico<>, até <#e8a800ff>${srStacks}<>.`n`nRaio: Com <#e8a800ff>${srStacks}<> acúmulos de Energia, sua próxima instância de <#ff9028ff>dano físico<> consome todos os acúmulos para causar <#a974ffff>${srDmg} de dano mágico bônus<> e concede <#ffffffff>${srMs}%<> de <$speedIcon> <#ffffffff>Velocidade de Movimento<> por <#e8a800ff>${srDur} segundos<>."
$i18n.'pt-BR'.radiant_stormrazor.option = "Energizado: Ganha <#e8a800ff>1<> acúmulo de Energia por segundo e <#e8a800ff>3<> acúmulos sempre que causa <#ff9028ff>dano físico<>, até <#e8a800ff>${rsrStacks}<>.`n`nRaio: Com <#e8a800ff>${rsrStacks}<> acúmulos de Energia, sua próxima instância de <#ff9028ff>dano físico<> consome todos os acúmulos para causar <#a974ffff>${rsrDmg} de dano mágico bônus<> e concede <#ffffffff>${rsrMs}%<> de <$speedIcon> <#ffffffff>Velocidade de Movimento<> por <#e8a800ff>${rsrDur} segundos<>."
...
$i18n.ru.shadowflame.option = "Огненный цветок: Ваш <#a974ffff>магический урон<> <#ff9028ff>на 20% сильнее<> против врагов, чьё <#d94c49ff>здоровье ниже ${sfThreshold}% от максимального<>."
$i18n.ru.radiant_shadowflame.option = "Огненный цветок: Ваш <#a974ffff>магический урон<> <#ff9028ff>на 20% сильнее<> против врагов, чьё <#d94c49ff>здоровье ниже ${rsfThreshold}% от максимального<>."
...
$i18n.ru.turbo_chemtank.option = "Сверхзаряд: Даёт <#d48294ff>${tcForce}<> <$forceIcon> <#d48294ff>адаптивной силы<>. Получение урона от вражеского чемпиона даёт <#ffffffff>${tcMs}%<> <$speedIcon> <#ffffffff>скорости передвижения<> и <#92dc7bff>иммунитет к эффектам контроля<> на <#e8a800ff>${tcDur} секунд<> (перезарядка ${tcCd} секунд)."
$i18n.ru.radiant_turbo_chemtank.option = "Сверхзаряд: Даёт <#d48294ff>${rtcForce}<> <$forceIcon> <#d48294ff>адаптивной силы<>. Получение урона от вражеского чемпиона даёт <#ffffffff>${rtcMs}%<> <$speedIcon> <#ffffffff>скорости передвижения<> и <#92dc7bff>иммунитет к эффектам контроля<> на <#e8a800ff>${rtcDur} секунд<> (перезарядка ${rtcCd} секунд)."
$i18n.ru.stormrazor.option = "Заряд: Получает <#e8a800ff>1<> заряд Энергии каждую секунду и <#e8a800ff>3<> заряда при нанесении <#ff9028ff>физического урона<>, до <#e8a800ff>${srStacks}<>.`n`nМолния: При <#e8a800ff>${srStacks}<> зарядах Энергии ваш следующий <#ff9028ff>физический урон<> расходует все заряды, нанося <#a974ffff>${srDmg} дополнительного магического урона<> и давая <#ffffffff>${srMs}%<> <$speedIcon> <#ffffffff>скорости передвижения<> на <#e8a800ff>${srDur} секунды<>."
$i18n.ru.radiant_stormrazor.option = "Заряд: Получает <#e8a800ff>1<> заряд Энергии каждую секунду и <#e8a800ff>3<> заряда при нанесении <#ff9028ff>физического урона<>, до <#e8a800ff>${rsrStacks}<>.`n`nМолния: При <#e8a800ff>${rsrStacks}<> зарядах Энергии ваш следующий <#ff9028ff>физический урон<> расходует все заряды, нанося <#a974ffff>${rsrDmg} дополнительного магического урона<> и давая <#ffffffff>${rsrMs}%<> <$speedIcon> <#ffffffff>скорости передвижения<> на <#e8a800ff>${rsrDur} секунды<>."
...
Write-Host "  Turbo Chemtank:          ${tcForce} force / ${tcMs}% MS + CC immunity ${tcDur}s / ${tcCd}s cooldown"
Write-Host "  Radiant Turbo Chemtank:  ${rtcForce} force / ${rtcMs}% MS + CC immunity ${rtcDur}s / ${rtcCd}s cooldown"
