...
$i18n.vi.stormrazor.option = "Tích Điện: Nhận <#e8a800ff>1<> điểm <#e8a800ff>Tích Điện<> mỗi giây và <#e8a800ff>3<> điểm mỗi khi gây <#ff9028ff>sát thương vật lí<>, tối đa <#e8a800ff>${srStacks}<>.`n`nTia Sét: Khi đạt <#e8a800ff>${srStacks} điểm Tích Điện<>, đòn <#ff9028ff>sát thương vật lí<> tiếp theo tiêu hao toàn bộ điểm để gây <#a974ffff>${srDmg} sát thương phép cộng thêm<> và tăng <#ffffffff>${srMs}%<> <$speedIcon> <#ffffffff>tốc độ di chuyển<> trong <#e8a800ff>${srDur} giây<>."
$i18n.vi.radiant_stormrazor.option = "Tích Điện: Nhận <#e8a800ff>1<> điểm <#e8a800ff>Tích Điện<> mỗi giây và <#e8a800ff>3<> điểm mỗi khi gây <#ff9028ff>sát thương vật lí<>, tối đa <#e8a800ff>${rsrStacks}<>.`n`nTia Sét: Khi đạt <#e8a800ff>${rsrStacks} điểm Tích Điện<>, đòn <#ff9028ff>sát thương vật lí<> tiếp theo tiêu hao toàn bộ điểm để gây <#a974ffff>${rsrDmg} sát thương phép cộng thêm<> và tăng <#ffffffff>${rsrMs}%<> <$speedIcon> <#ffffffff>tốc độ di chuyển<> trong <#e8a800ff>${rsrDur} giây<>."
...
$i18n.'zh-hans'.stormrazor.option = "蓄能：每秒获得 <#e8a800ff>1<> 层<#e8a800ff>蓄能<>，每次造成 <#ff9028ff>物理伤害<> 时获得 <#e8a800ff>3<> 层，最多 <#e8a800ff>${srStacks}<> 层。`n`n雷霆：拥有 <#e8a800ff>${srStacks} 层蓄能<>时，你的下一次 <#ff9028ff>物理伤害<> 会消耗所有蓄能，额外造成 <#a974ffff>${srDmg} 点魔法伤害<>，并使你获得 <#ffffffff>${srMs}%<> <$speedIcon> <#ffffffff>移动速度<>，持续 <#e8a800ff>${srDur}秒<>。"
$i18n.'zh-hans'.radiant_stormrazor.option = "蓄能：每秒获得 <#e8a800ff>1<> 层<#e8a800ff>蓄能<>，每次造成 <#ff9028ff>物理伤害<> 时获得 <#e8a800ff>3<> 层，最多 <#e8a800ff>${rsrStacks}<> 层。`n`n雷霆：拥有 <#e8a800ff>${rsrStacks} 层蓄能<>时，你的下一次 <#ff9028ff>物理伤害<> 会消耗所有蓄能，额外造成 <#a974ffff>${rsrDmg} 点魔法伤害<>，并使你获得 <#ffffffff>${rsrMs}%<> <$speedIcon> <#ffffffff>移动速度<>，持续 <#e8a800ff>${rsrDur}秒<>。"
