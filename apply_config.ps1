...
$i18n.vi.deaths_dance.option = "Phớt Lờ Đau Đớn: <#e8a800ff>${ddDelay}%<> sát thương nhận vào được tích trữ và gây lại cho bạn theo thời gian dưới dạng <#ff9028ff>sát thương vật lí<> (tối đa <#60e84dff>${ddBurnCap}%<> <$hpIcon> <#60e84dff>máu tối đa<> mỗi giây).`n`nCự Tuyệt: Tham gia hạ gục một tướng địch sẽ xóa lượng sát thương tích trữ còn lại và <$hpRegenIcon> <#60e84dff>hồi<> cho bạn <#60e84dff>${ddFlatHeal}<> + <#60e84dff>${ddHeal}%<> <#60e84dff>máu đã mất<>."
$i18n.vi.radiant_deaths_dance.option = "Phớt Lờ Đau Đớn: <#e8a800ff>${rddDelay}%<> sát thương nhận vào được tích trữ và gây lại cho bạn theo thời gian dưới dạng <#ff9028ff>sát thương vật lí<> (tối đa <#60e84dff>${rddBurnCap}%<> <$hpIcon> <#60e84dff>máu tối đa<> mỗi giây).`n`nCự Tuyệt: Tham gia hạ gục một tướng địch sẽ xóa lượng sát thương tích trữ còn lại và <$hpRegenIcon> <#60e84dff>hồi<> cho bạn <#60e84dff>${rddFlatHeal}<> + <#60e84dff>${rddHeal}%<> <#60e84dff>máu đã mất<>."
...
$i18n.'zh-hans'.deaths_dance.option = "无视痛苦：受到伤害的 <#e8a800ff>${ddDelay}%<> 会被储存，并随时间作为 <#ff9028ff>额外物理伤害<> 返还给你（每秒最多为你的 <$hpIcon> <#60e84dff>最大生命值<>的 <#60e84dff>${ddBurnCap}%<>）。`n`n拒止：参与击杀敌方英雄会清除剩余的储存伤害，并为你<$hpRegenIcon> <#60e84dff>回复<> <#60e84dff>${ddFlatHeal}<> + <#60e84dff>${ddHeal}%<> 的<#60e84dff>已损失生命值<>。"
$i18n.'zh-hans'.radiant_deaths_dance.option = "无视痛苦：受到伤害的 <#e8a800ff>${rddDelay}%<> 会被储存，并随时间作为 <#ff9028ff>额外物理伤害<> 返还给你（每秒最多为你的 <$hpIcon> <#60e84dff>最大生命值<>的 <#60e84dff>${rddBurnCap}%<>）。`n`n拒止：参与击杀敌方英雄会清除剩余的储存伤害，并为你<$hpRegenIcon> <#60e84dff>回复<> <#60e84dff>${rddFlatHeal}<> + <#60e84dff>${rddHeal}%<> 的<#60e84dff>已损失生命值<>。"
