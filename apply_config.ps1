...
$zekAura = "Aura: Grant <#d48294ff>{0}<> <$forceIcon> <#d48294ff>Adaptive Force<> to all allied champions within <#ff86c2ff>{1} <$rangeIcon> range<>."
...
$zekAuraVi = "Hào Quang: Cấp <#d48294ff>{0}<> <$forceIcon> <#d48294ff>Lực Thích Ứng<> cho mọi tướng đồng minh trong phạm vi <#ff86c2ff>{1}<> <$rangeIcon>."
...
$zekAuraZh = "光环：为 <#ff86c2ff>{1} <$rangeIcon> 射程<>范围内的所有友方英雄提供 <#d48294ff>{0}<> <$forceIcon> <#d48294ff>自适应之力<>。"
...
$zekAuraPt = "Aura: Concede <#d48294ff>{0}<> <$forceIcon> de <#d48294ff>Força Adaptativa<> a todos os campeões aliados dentro de <#ff86c2ff>{1} <$rangeIcon> alcance<>."
...
$zekAuraRu = "Аура: Даёт <#d48294ff>{0}<> <$forceIcon> <#d48294ff>адаптивной силы<> всем союзным чемпионам в пределах <#ff86c2ff>{1} <$rangeIcon> дальности<>."
