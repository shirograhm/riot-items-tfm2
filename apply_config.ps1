...
$i18n.en.unending_despair.option = "Anguish: Landing an Ability on an enemy champion heals you for <$hpRegenIcon> <#60e84dff>${udFlat}<> + <#60e84dff>${udHpPct}%<> of your <$hpIcon> <#60e84dff>maximum health<>."
$i18n.en.radiant_unending_despair.option = "Anguish: Landing an Ability on an enemy champion heals you for <$hpRegenIcon> <#60e84dff>${rudFlat}<> + <#60e84dff>${rudHpPct}%<> of your <$hpIcon> <#60e84dff>maximum health<>."
...
$i18n.vi.unending_despair.option = "Thống khổ: Kĩ năng trúng bạn sẽ hồi máu một lượng tương ứng <$hpRegenIcon> <#60e84dff>${udFlat}<> + <#60e84dff>${udHpPct}%<> <$hpIcon> <#60e84dff>máu tối đa<> cho bản thân."
$i18n.vi.radiant_unending_despair.option = "Thống khổ: Kĩ năng trúng bạn sẽ hồi máu một lượng tương ứng <$hpRegenIcon> <#60e84dff>${rudFlat}<> + <#60e84dff>${rudHpPct}%<> <$hpIcon> <#60e84dff>máu tối đa<> cho bản thân."
...
$i18n.'zh-hans'.unending_despair.option = "苦楚：技能命中时，回复 <$hpRegenIcon> <#60e84dff>${udFlat}<> + 你的 <$hpIcon> <#60e84dff>最大生命值<>的 <#60e84dff>${udHpPct}%<> 的生命值。"
$i18n.'zh-hans'.radiant_unending_despair.option = "苦楚：技能命中时，回复 <$hpRegenIcon> <#60e84dff>${rudFlat}<> + 你的 <$hpIcon> <#60e84dff>最大生命值<>的 <#60e84dff>${rudHpPct}%<> 的生命值。"
...
$i18n.'pt-BR'.unending_despair.option = "Angústia: Suas mágias te curam em <$hpRegenIcon> <#60e84dff>${udFlat}<> + <#60e84dff>${udHpPct}%<> da sua <$hpIcon> <#60e84dff>Vida Máxima<>."
$i18n.'pt-BR'.radiant_unending_despair.option = "Angústia: Suas mágias te curam em <$hpRegenIcon> <#60e84dff>${rudFlat}<> + <#60e84dff>${rudHpPct}%<> da sua <$hpIcon> <#60e84dff>Vida Máxima<>."
...
$i18n.ru.unending_despair.option = "Страдание: Попадания умениями восстанавливают вам <$hpRegenIcon> <#60e84dff>${udFlat}<> + <#60e84dff>${udHpPct}%<> от вашего <$hpIcon> <#60e84dff>максимального здоровья<>."
$i18n.ru.radiant_unending_despair.option = "Страдание: Попадания умениями восстанавливают вам <$hpRegenIcon> <#60e84dff>${rudFlat}<> + <#60e84dff>${rudHpPct}%<> от вашего <$hpIcon> <#60e84dff>максимального здоровья<>."
...
$i18n.ko.unending_despair.option = "고뇌: 적 챔피언에게 스킬을 적중시키면 <$hpRegenIcon> <#60e84dff>${udFlat}<> + <$hpIcon> <#60e84dff>최대 체력<>의 <#60e84dff>${udHpPct}%<>만큼 체력을 회복합니다."
$i18n.ko.radiant_unending_despair.option = "고뇌: 적 챔피언에게 스킬을 적중시키면 <$hpRegenIcon> <#60e84dff>${rudFlat}<> + <$hpIcon> <#60e84dff>최대 체력<>의 <#60e84dff>${rudHpPct}%<>만큼 체력을 회복합니다."
