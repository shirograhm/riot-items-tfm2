...
$bbEn = "$lethEn`n`nSabotage: Upon damaging a turret, deal <#ff9028ff>{1}<> + <#ff9028ff>{2}%<> of your <$adIcon> <#ff9028ff>Attack Damage<> as <#ff9028ff>bonus physical damage<> (<#e8a800ff>{3} second<> cooldown)."
...
$bbVi = "$lethVi`n`nPhá Hoại: Khi gây sát thương lên trụ, gây <#ff9028ff>{1}<> + <#ff9028ff>{2}%<> <$adIcon> <#ff9028ff>SMCK<> dưới dạng <#ff9028ff>sát thương vật lí cộng thêm<> (hồi chiêu <#e8a800ff>{3} giây<>)."
...
$bbZh = "$lethZh`n`n破坏：对防御塔造成伤害时，造成 <#ff9028ff>{1}<> + <$adIcon> <#ff9028ff>攻击力<>的 <#ff9028ff>{2}%<> 作为<#ff9028ff>额外物理伤害<>（冷却 <#e8a800ff>{3}秒<>）。"
...
$bbPt = "$lethPt`n`nSabotagem: Ao causar dano a uma torre, causa <#ff9028ff>{1}<> + <#ff9028ff>{2}%<> do seu <$adIcon> <#ff9028ff>Dano de Ataque<> como <#ff9028ff>dano físico bônus<> (recarga de <#e8a800ff>{3} segundos<>)."
...
$bbRu = "$lethRu`n`nСаботаж: При нанесении урона башне наносит <#ff9028ff>{1}<> + <#ff9028ff>{2}%<> вашей <$adIcon> <#ff9028ff>Силы Атаки<> как <#ff9028ff>дополнительный физический урон<> (перезарядка <#e8a800ff>{3} секунд<>)."
