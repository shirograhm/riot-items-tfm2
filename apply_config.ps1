...
$i18n.en.shadowflame.option = "Cinderbloom: Your <#a974ffff>magic<> and <#e1f7f5ff>true damage<> is <#e8a800ff>20% stronger<> against enemies <#d94c49ff>below ${sfThreshold}% maximum health<>."
$i18n.en.radiant_shadowflame.option = "Cinderbloom: Your <#a974ffff>magic<> and <#e1f7f5ff>true damage<> is <#e8a800ff>20% stronger<> against enemies <#d94c49ff>below ${rsfThreshold}% maximum health<>."
...
$i18n.en.deaths_dance.option = "Ignore Pain: <#e8a800ff>${ddDelay}%<> of the damage you take is dealt over time as <#e1f7f5ff>true damage<> (up to <#60e84dff>${ddBurnCap}%<> of your <$hpIcon> <#60e84dff>maximum health<> per second).`n`nDefy: Scoring a <#e8a800ff>takedown<> on an enemy champion cleanses the remaining stored damage and <$hpRegenIcon> <#60e84dff>heals you<> for <#60e84dff>${ddFlatHeal}<> + <#60e84dff>${ddHeal}%<> of your <#60e84dff>missing health<>."
$i18n.en.radiant_deaths_dance.option = "Ignore Pain: <#e8a800ff>${rddDelay}%<> of the damage you take is dealt over time as <#e1f7f5ff>true damage<> (up to <#60e84dff>${rddBurnCap}%<> of your <$hpIcon> <#60e84dff>maximum health<> per second).`n`nDefy: Scoring a <#e8a800ff>takedown<> on an enemy champion cleanses the remaining stored damage and <$hpRegenIcon> <#60e84dff>heals you<> for <#60e84dff>${rddFlatHeal}<> + <#60e84dff>${rddHeal}%<> of your <#60e84dff>missing health<>."
...
$bbEn = "$lethEn`n`nSabotage: Scoring a <#e8a800ff>takedown<> on an enemy champion grants <#92dc7bff>Sabotage<> for <#e8a800ff>{3} seconds<>, empowering your next basic attack against a turret to deal <#ff9028ff>{1}<> + <#ff9028ff>{2}%<> of your <$adIcon> <#ff9028ff>Attack Damage<> as <#e1f7f5ff>bonus true damage<>."
...
$i18n.vi.shadowflame.option = "Hạt Tro: <#a974ffff>Sát thương phép<> và <#e1f7f5ff>Sát thương Chuẩn<> của bạn <#e8a800ff>mạnh hơn 20%<> khi gây lên kẻ địch <#d94c49ff>dưới ${sfThreshold}% máu tối đa<>."
$i18n.vi.radiant_shadowflame.option = "Hạt Tro: <#a974ffff>Sát thương phép<> và <#e1f7f5ff>Sát thương Chuẩn<> của bạn <#e8a800ff>mạnh hơn 20%<> khi gây lên kẻ địch <#d94c49ff>dưới ${rsfThreshold}% máu tối đa<>."
...
$i18n.vi.deaths_dance.option = "Phớt Lờ Đau Đớn: <#e8a800ff>${ddDelay}%<> sát thương nhận vào được tích trữ và gây lại cho bạn theo thời gian dưới dạng <#e1f7f5ff>sát thương chuẩn<> (tối đa <#60e84dff>${ddBurnCap}%<> <$hpIcon> <#60e84dff>máu tối đa<> mỗi giây).`n`nCự Tuyệt: Tham gia hạ gục một tướng địch sẽ xóa lượng sát thương tích trữ còn lại và <$hpRegenIcon> <#60e84dff>hồi<> cho bạn <#60e84dff>${ddFlatHeal}<> + <#60e84dff>${ddHeal}%<> <#60e84dff>máu đã mất<>."
$i18n.vi.radiant_deaths_dance.option = "Phớt Lờ Đau Đớn: <#e8a800ff>${rddDelay}%<> sát thương nhận vào được tích trữ và gây lại cho bạn theo thời gian dưới dạng <#e1f7f5ff>sát thương chuẩn<> (tối đa <#60e84dff>${rddBurnCap}%<> <$hpIcon> <#60e84dff>máu tối đa<> mỗi giây).`n`nCự Tuyệt: Tham gia hạ gục một tướng địch sẽ xóa lượng sát thương tích trữ còn lại và <$hpRegenIcon> <#60e84dff>hồi<> cho bạn <#60e84dff>${rddFlatHeal}<> + <#60e84dff>${rddHeal}%<> <#60e84dff>máu đã mất<>."
...
$bbVi = "$lethVi`n`nPhá Hoại: Tham gia hạ gục một tướng địch sẽ trao <#92dc7bff>Phá Hoại<> trong <#e8a800ff>{3} giây<>, tăng cường đòn đánh thường tiếp theo của bạn lên trụ để gây <#ff9028ff>{1}<> + <#ff9028ff>{2}%<> <$adIcon> <#ff9028ff>SMCK<> dưới dạng <#e1f7f5ff>sát thương chuẩn cộng thêm<>."
...
$i18n.'zh-hans'.shadowflame.option = "余烬绽放：你的<#a974ffff>魔法伤害<>和<#e1f7f5ff>真实伤害<>对<#d94c49ff>最大生命值低于${sfThreshold}%<>的敌人<#e8a800ff>提高20%<>。"
$i18n.'zh-hans'.radiant_shadowflame.option = "余烬绽放：你的<#a974ffff>魔法伤害<>和<#e1f7f5ff>真实伤害<>对<#d94c49ff>最大生命值低于${rsfThreshold}%<>的敌人<#e8a800ff>提高20%<>。"
...
$i18n.'zh-hans'.deaths_dance.option = "无视痛苦：受到伤害的 <#e8a800ff>${ddDelay}%<> 会被储存，并随时间作为 <#e1f7f5ff>额外真实伤害<> 返还给你（每秒最多为你的 <$hpIcon> <#60e84dff>最大生命值<>的 <#60e84dff>${ddBurnCap}%<>）。`n`n拒止：参与击杀敌方英雄会清除剩余的储存伤害，并为你<$hpRegenIcon> <#60e84dff>回复<> <#60e84dff>${ddFlatHeal}<> + <#60e84dff>${ddHeal}%<> 的<#60e84dff>已损失生命值<>。"
$i18n.'zh-hans'.radiant_deaths_dance.option = "无视痛苦：受到伤害的 <#e8a800ff>${rddDelay}%<> 会被储存，并随时间作为 <#e1f7f5ff>额外真实伤害<> 返还给你（每秒最多为你的 <$hpIcon> <#60e84dff>最大生命值<>的 <#60e84dff>${rddBurnCap}%<>）。`n`n拒止：参与击杀敌方英雄会清除剩余的储存伤害，并为你<$hpRegenIcon> <#60e84dff>回复<> <#60e84dff>${rddFlatHeal}<> + <#60e84dff>${rddHeal}%<> 的<#60e84dff>已损失生命值<>。"
...
$bbZh = "$lethZh`n`n破坏：参与击杀敌方英雄时，获得 <#92dc7bff>破坏<> 效果，持续 <#e8a800ff>{3}秒<>，强化你对防御塔的下一次普通攻击，造成 <#ff9028ff>{1}<> + <$adIcon> <#ff9028ff>攻击力<>的 <#ff9028ff>{2}%<> 作为<#e1f7f5ff>额外真实伤害<>。"
...
$i18n.'pt-BR'.shadowflame.option = "Floregris: Seu <#a974ffff>dano mágico<> e <#e1f7f5ff>dano verdadeiro<> são <#e8a800ff>20% mais fortes<> contra inimigos <#d94c49ff>abaixo de ${sfThreshold}% da Vida Máxima<>."
$i18n.'pt-BR'.radiant_shadowflame.option = "Floregris: Seu <#a974ffff>dano mágico<> e <#e1f7f5ff>dano verdadeiro<> são <#e8a800ff>20% mais fortes<> contra inimigos <#d94c49ff>abaixo de ${rsfThreshold}% da Vida Máxima<>."
...
$bbPt = "$lethPt`n`nSabotagem: Ao participar do abate de um campeão inimigo, concede <#92dc7bff>Sabotagem<> por <#e8a800ff>{3} segundos<>, potencializando seu próximo ataque básico contra uma torre para causar <#ff9028ff>{1}<> + <#ff9028ff>{2}%<> do seu <$adIcon> <#ff9028ff>Dano de Ataque<> como <#e1f7f5ff>dano verdadeiro bônus<>."
...
$i18n.ru.shadowflame.option = "Огненный цветок: Ваш <#a974ffff>магический урон<> и <#e1f7f5ff>чистый урон<> <#e8a800ff>на 20% сильнее<> против врагов, чьё <#d94c49ff>здоровье ниже ${sfThreshold}% от максимального<>."
$i18n.ru.radiant_shadowflame.option = "Огненный цветок: Ваш <#a974ffff>магический урон<> и <#e1f7f5ff>чистый урон<> <#e8a800ff>на 20% сильнее<> против врагов, чьё <#d94c49ff>здоровье ниже ${rsfThreshold}% от максимального<>."
...
$bbRu = "$lethRu`n`nСаботаж: При участии в убийстве вражеского чемпиона даёт <#92dc7bff>Саботаж<> на <#e8a800ff>{3} секунд<>, усиливая вашу следующую базовую атаку по башне, чтобы нанести <#ff9028ff>{1}<> + <#ff9028ff>{2}%<> вашей <$adIcon> <#ff9028ff>Силы Атаки<> как <#e1f7f5ff>дополнительный чистый урон<>."
...
$i18n.ko.shadowflame.option = "잿불꽃: <#d94c49ff>최대 체력이 ${sfThreshold}% 아래인<> 적에게 입히는 <#a974ffff>마법 피해<>와 <#e1f7f5ff>고정 피해<>가 <#e8a800ff>20% 증가<>합니다."
$i18n.ko.radiant_shadowflame.option = "잿불꽃: <#d94c49ff>최대 체력이 ${rsfThreshold}% 아래인<> 적에게 입히는 <#a974ffff>마법 피해<>와 <#e1f7f5ff>고정 피해<>가 <#e8a800ff>20% 증가<>합니다."
...
$i18n.ko.deaths_dance.option = "고통 무시: 받는 피해의 <#e8a800ff>${ddDelay}%<>를 지속적으로 <#e1f7f5ff>고정 피해<>로 받습니다. 초당 피해량은 <$hpIcon> <#60e84dff>최대 체력<>의 <#60e84dff>${ddBurnCap}%<>를 넘지 않습니다.`n`n저항: 적 챔피언 처치에 관여하면 남아 있는 지연 피해를 제거하고 <$hpRegenIcon> <#60e84dff>${ddFlatHeal}<> + <#60e84dff>잃은 체력의 ${ddHeal}%<>만큼 체력을 회복합니다."
$i18n.ko.radiant_deaths_dance.option = "고통 무시: 받는 피해의 <#e8a800ff>${rddDelay}%<>를 지속적으로 <#e1f7f5ff>고정 피해<>로 받습니다. 초당 피해량은 <$hpIcon> <#60e84dff>최대 체력<>의 <#60e84dff>${rddBurnCap}%<>를 넘지 않습니다.`n`n저항: 적 챔피언 처치에 관여하면 남아 있는 지연 피해를 제거하고 <$hpRegenIcon> <#60e84dff>${rddFlatHeal}<> + <#60e84dff>잃은 체력의 ${rddHeal}%<>만큼 체력을 회복합니다."
...
$bbKo = "$lethKo`n`n파괴 공작: 적 챔피언 처치에 관여하면 <#e8a800ff>{3}초<> 동안 <#92dc7bff>파괴 공작<>을 얻습니다. 이 효과를 보유한 동안 포탑을 대상으로 하는 다음 기본 공격이 <#ff9028ff>{1}<> + <$adIcon> <#ff9028ff>공격력의 {2}%<>만큼 <#e1f7f5ff>추가 고정 피해<>를 입힙니다."
