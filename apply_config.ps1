...
$rmHpPct = if ($null -ne $config.riftmaker.effect_caster_hp_percent_power) { [int]$config.riftmaker.effect_caster_hp_percent_power }              else { 1 }
...
$rrmHpPct = if ($null -ne $config.radiant_riftmaker.effect_caster_hp_percent_power) { [int]$config.radiant_riftmaker.effect_caster_hp_percent_power } else { 1 }
