...
$i18n.en.deaths_dance.option = "Ignore Pain: <#e8a800ff>${ddDelay}%<> of the damage you take is dealt over time as <#ff9028ff>physical damage<> (up to <#60e84dff>${ddBurnCap}%<> of your <$hpIcon> <#60e84dff>maximum health<> per second).`n`nDefy: Scoring a takedown on an enemy champion cleanses the remaining stored damage and <#60e84dff>heals you<> for <#60e84dff>${ddFlatHeal}<> + <#60e84dff>${ddHeal}%<> of your <#60e84dff>missing health<>."
$i18n.en.radiant_deaths_dance.option = "Ignore Pain: <#e8a800ff>${rddDelay}%<> of the damage you take is dealt over time as <#ff9028ff>physical damage<> (up to <#60e84dff>${rddBurnCap}%<> of your <$hpIcon> <#60e84dff>maximum health<> per second).`n`nDefy: Scoring a takedown on an enemy champion cleanses the remaining stored damage and <#60e84dff>heals you<> for <#60e84dff>${rddFlatHeal}<> + <#60e84dff>${rddHeal}%<> of your <#60e84dff>missing health<>."
...
$hubEn = "$lethEn`n`nEminence: Scoring a takedown on an enemy champion generates a permanent stack and grants <#ff9028ff>{1}<> (+{2} per stack) <#ff9028ff>bonus<> <$adIcon> <#ff9028ff>Attack Damage<> for <#e8a800ff>{3} seconds<>."
