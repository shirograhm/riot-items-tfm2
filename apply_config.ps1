...
$fluxEn = "$lethEn`n`n<#ff7a3eff>Flux<>: Gain <#4b7cffff>{1}<> (<#4b7cffff>+{2}<> per <#ffdd8eff>1 <$armorPenIcon> Lethality<>) <$cdrIcon> <#4b7cffff>Ultimate Ability Haste<>."
...
$i18n.en.chemtech_putrifier.option = "<#ff7a3eff>Grievous Wounds<>: Dealing <#a974ffff>magic damage<> to an enemy champion <#d94c49ff>reduces their healing by ${cptHeal}%<> for <#e8a800ff>${cptDur} seconds<>."
$i18n.en.radiant_chemtech_putrifier.option = "<#ff7a3eff>Grievous Wounds<>: Dealing <#a974ffff>magic damage<> to an enemy champion <#d94c49ff>reduces their healing by ${rcptHeal}%<> for <#e8a800ff>${rcptDur} seconds<>."
...
$fluxVi = "$lethVi`n`n<#ff7a3eff>Tái Thiết<>: Nhận <#4b7cffff>{1}<> <#ffdd8eff>(+{2} mỗi 1 <$armorPenIcon> Xuyên Giáp Trắng)<> <$cdrIcon> <#4b7cffff>Điểm Hồi Chiêu Cuối<>."
...
$i18n.vi.chemtech_putrifier.option = "<#ff7a3eff>Vết thương chí mạng<>: Gây <#a974ffff>sát thương phép<> lên tướng địch <#d94c49ff>giảm hồi máu của chúng ${cptHeal}%<> trong <#e8a800ff>${cptDur} giây<>."
$i18n.vi.radiant_chemtech_putrifier.option = "<#ff7a3eff>Vết thương chí mạng<>: Gây <#a974ffff>sát thương phép<> lên tướng địch <#d94c49ff>giảm hồi máu của chúng ${rcptHeal}%<> trong <#e8a800ff>${rcptDur} giây<>."
...
$fluxZh = "$lethZh`n`n<#ff7a3eff>涌动<>：获得 <#4b7cffff>{1}<> <#ffdd8eff>（每 1 点<$armorPenIcon> 穿甲 +{2}）<> <$cdrIcon> <#4b7cffff>终极技能急速<>。"
...
$i18n.'zh-hans'.chemtech_putrifier.option = "<#ff7a3eff>重伤<>：对敌方英雄造成<#a974ffff>魔法伤害<>会使其<#d94c49ff>治疗效果降低${cptHeal}%<>，持续 <#e8a800ff>${cptDur}秒<>。"
$i18n.'zh-hans'.radiant_chemtech_putrifier.option = "<#ff7a3eff>重伤<>：对敌方英雄造成<#a974ffff>魔法伤害<>会使其<#d94c49ff>治疗效果降低${rcptHeal}%<>，持续 <#e8a800ff>${rcptDur}秒<>。"
...
$fluxPt = "$lethPt`n`n<#ff7a3eff>Fluxo<>: Recebe <#4b7cffff>{1}<> <#ffdd8eff>(+{2} por 1 de <$armorPenIcon> Letalidade)<> <$cdrIcon> <#4b7cffff>de Aceleração de Habilidade da Ultimate<>."
...
$i18n.'pt-BR'.chemtech_putrifier.option = "<#ff7a3eff>Ferimentos Graves<>: Causar <#a974ffff>dano mágico<> a um campeão inimigo <#d94c49ff>reduz a cura dele em ${cptHeal}%<> por <#e8a800ff>${cptDur} segundos<>."
$i18n.'pt-BR'.radiant_chemtech_putrifier.option = "<#ff7a3eff>Ferimentos Graves<>: Causar <#a974ffff>dano mágico<> a um campeão inimigo <#d94c49ff>reduz a cura dele em ${rcptHeal}%<> por <#e8a800ff>${rcptDur} segundos<>."
...
$fluxRu = "$lethRu`n`n<#ff7a3eff>Непрерывность<>: Даёт <#4b7cffff>{1}<> <#ffdd8eff>(+{2} за 1 ед. <$armorPenIcon> летальности)<> <$cdrIcon> <#4b7cffff>ускорения абсолютных умений<>."
...
$i18n.ru.chemtech_putrifier.option = "<#ff7a3eff>Тяжёлые раны<>: Нанесение <#a974ffff>магического урона<> вражескому чемпиону <#d94c49ff>снижает его лечение на ${cptHeal}%<> на <#e8a800ff>${cptDur} секунды<>."
$i18n.ru.radiant_chemtech_putrifier.option = "<#ff7a3eff>Тяжёлые раны<>: Нанесение <#a974ffff>магического урона<> вражескому чемпиону <#d94c49ff>снижает его лечение на ${rcptHeal}%<> на <#e8a800ff>${rcptDur} секунды<>."
...
$fluxKo = "$lethKo`n`n<#ff7a3eff>전이 표식<>: <$cdrIcon> <#4b7cffff>궁극기 가속<>이 <#4b7cffff>{1}<> <#ffdd8eff>(<$armorPenIcon> 물리 관통력 1당 +{2})<> 증가합니다."
...
$i18n.ko.chemtech_putrifier.option = "<#ff7a3eff>고통스러운 상처<>: 적 챔피언에게 <#a974ffff>마법 피해<>를 입히면 <#e8a800ff>${cptDur}초<> 동안 대상의 <#d94c49ff>회복량이 ${cptHeal}% 감소<>합니다."
$i18n.ko.radiant_chemtech_putrifier.option = "<#ff7a3eff>고통스러운 상처<>: 적 챔피언에게 <#a974ffff>마법 피해<>를 입히면 <#e8a800ff>${rcptDur}초<> 동안 대상의 <#d94c49ff>회복량이 ${rcptHeal}% 감소<>합니다."
...
Write-Host "  Experimental Hexplate:         ${hexUltCdr} Ultimate Ability Haste"
Write-Host "  Radiant Experimental Hexplate: ${rhexUltCdr} Ultimate Ability Haste"
...
Write-Host "  Axiom Arc:                   ${aaLeth} Lethality, ${aaUltCdr} +${aaPerLeth}/Lethality Ultimate Ability Haste (Radiant ${raaLeth}, ${raaUltCdr} +${raaPerLeth})"
