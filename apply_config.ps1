...
$hubEn = "$lethEn`n`nEminence: Killing an enemy champion generates a permanent stack and grants <#ff9028ff>{1}<> (+{2} per stack) <#ff9028ff>bonus<> <$adIcon> <#ff9028ff>Attack Damage<> for <#e8a800ff>{3} seconds<>."
...
$bbEn = "$lethEn`n`nSabotage: Killing an enemy champion grants <#92dc7bff>Sabotage<> for <#e8a800ff>{3} seconds<>, empowering your next Attack against a turret to deal <#ff9028ff>{1}<> + <#ff9028ff>{2}%<> of your <$adIcon> <#ff9028ff>Attack Damage<> as <#ff9028ff>bonus physical damage<>."
...
$hubVi = "$lethVi`n`nUy Danh: Khi hạ gục một tướng địch, tạo một cộng dồn vĩnh viễn và nhận <#ff9028ff>{1}<> (+{2} mỗi cộng dồn) <$adIcon> <#ff9028ff>SMCK cộng thêm<> trong <#e8a800ff>{3} giây<>."
...
$bbVi = "$lethVi`n`nPhá Hoại: Khi hạ gục một tướng địch, nhận một cộng dồn <#92dc7bff>Phá Hoại<> trong <#e8a800ff>{3} giây<>, tăng cường đòn đánh tiếp theo lên trụ để gây <#ff9028ff>{1}<> + <#ff9028ff>{2}%<> <$adIcon> <#ff9028ff>SMCK<> dưới dạng <#ff9028ff>sát thương vật lí cộng thêm<>."
...
$hubZh = "$lethZh`n`n威望：击杀敌方英雄时生成一层永久印记，并获得 <#ff9028ff>{1}<>（每层+{2}）<#ff9028ff>额外<$adIcon> 攻击力<>，持续 <#e8a800ff>{3}秒<>。"
...
$bbZh = "$lethZh`n`n破坏：击杀敌方英雄时获得一层<#92dc7bff>破坏<>，持续 <#e8a800ff>{3}秒<>，强化你对防御塔的下一次攻击，造成 <#ff9028ff>{1}<> + <$adIcon> <#ff9028ff>攻击力<>的 <#ff9028ff>{2}%<> 作为<#ff9028ff>额外物理伤害<>。"
...
$hubPt = "$lethPt`n`nEminência: Ao abater um campeão inimigo, gera um acúmulo permanente e concede <#ff9028ff>{1}<> (+{2} por acúmulo) de <$adIcon> <#ff9028ff>Dano de Ataque bônus<> por <#e8a800ff>{3} segundos<>."
...
$bbPt = "$lethPt`n`nSabotagem: Ao abater um campeão inimigo, ganha um acúmulo de <#92dc7bff>Sabotagem<> por <#e8a800ff>{3} segundos<>, potencializando seu próximo ataque contra uma torre para causar <#ff9028ff>{1}<> + <#ff9028ff>{2}%<> do seu <$adIcon> <#ff9028ff>Dano de Ataque<> como <#ff9028ff>dano físico bônus<>."
...
$hubRu = "$lethRu`n`nВозвышение: При убийстве вражеского чемпиона создаёт постоянный заряд и даёт <#ff9028ff>{1}<> (+{2} за заряд) <#ff9028ff>дополнительной<> <$adIcon> <#ff9028ff>Силы Атаки<> на <#e8a800ff>{3} секунд<>."
...
$bbRu = "$lethRu`n`nСаботаж: При убийстве вражеского чемпиона даёт заряд <#92dc7bff>Саботажа<> на <#e8a800ff>{3} секунд<>, усиливая вашу следующую атаку по башне: она наносит <#ff9028ff>{1}<> + <#ff9028ff>{2}%<> вашей <$adIcon> <#ff9028ff>Силы Атаки<> как <#ff9028ff>дополнительный физический урон<>."
