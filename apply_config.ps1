...
$rhsBonusHpPct = if ($null -ne $config.radiant_heartsteel.effect_bonus_hp_percent_of_damage) { [double]$config.radiant_heartsteel.effect_bonus_hp_percent_of_damage }   else { 10.0 }
