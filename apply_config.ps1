...
$i18n.en.yun_tal_wildarrows.option = "Practice Makes Lethal: Dealing <#ff9028ff>physical damage<> grants <#e8a800ff>${ytCrit}%<> <$critIcon> <#e8a800ff>Critical Strike Chance<> permanently, up to <#e8a800ff>${ytMaxCrit}%<>.`n`nFlurry: On attack, gain <#ceff99ff>${ytFlurryAS}%<> <$asIcon> <#ceff99ff>Attack Speed<> for <#e8a800ff>${ytDur} seconds<> (${ytCd} second cooldown)."
$i18n.en.radiant_yun_tal_wildarrows.option = "Practice Makes Lethal: Dealing <#ff9028ff>physical damage<> grants <#e8a800ff>${rytCrit}%<> <$critIcon> <#e8a800ff>Critical Strike Chance<> permanently, up to <#e8a800ff>${rytMaxCrit}%<>.`n`nFlurry: On attack, gain <#ceff99ff>${rytFlurryAS}%<> <$asIcon> <#ceff99ff>Attack Speed<> for <#e8a800ff>${rytDur} seconds<> (${rytCd} second cooldown)."
