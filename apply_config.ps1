...
$lockEn = "Legion: Nearby allies gain <#ffdd8eff>{0} <$armorIcon> armor<>, <#88ccffff>{1} <$mrIcon> magic resistance<>, and <#60e84dff>{2} <$hpRegenIcon> health regeneration<>. Minions gain <#e8a800ff>{3}%<> of this value."
