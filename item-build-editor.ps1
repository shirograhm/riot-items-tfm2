...
$ITEMS = @(
  ...
  'deathblade', 'deaths_dance', 'dragons_claw', 'experimental_hexplate', 'frozen_mallet',
  ...
  'spirit_visage', 'stormrazor', 'sunfire_cape', 'terminus', 'thornmail', 'turbo_chemtank', 'unending_despair',
