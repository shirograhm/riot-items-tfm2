...
Currently updated for game version 0.6.0_beta1. Also supports previous versions using an older build of the mod. See below for reference:  
Mod v0.9.4+ - v0.6.0_beta1
Mod v0.9.3 - v0.5.7
Mod v0.9.2 - v0.5.6
Mod v0.9.0-1 - v0.5.5
Mod v0.8.0+ - v0.5.4
